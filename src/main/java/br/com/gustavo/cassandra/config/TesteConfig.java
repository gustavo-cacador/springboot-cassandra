package br.com.gustavo.cassandra.config;

import br.com.gustavo.cassandra.PropType;
import br.com.gustavo.cassandra.bean.Department;
import br.com.gustavo.cassandra.bean.Product;
import br.com.gustavo.cassandra.bean.embedded.Prop;
...
public class TesteConfig {
    ...
    public TesteConfig(DepartmentRepository departmentRepository, ProductRepository productRepository) {
